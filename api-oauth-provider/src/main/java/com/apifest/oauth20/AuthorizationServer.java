...
import api.ICustomGrantTypeHandler;
...
public class AuthorizationServer {
    ...
    public String issueAuthorizationCode(HttpRequest req) throws OAuthException {
       ...
       System.out.println(authRequest.getRedirectUri());
        System.out.println(authRequest.getClientId());
        log.debug("authCode: {}", authCode.getCode());
        db.storeAuthCode(authCode);
System.out.println("save "+authCode.getCode());
    ...
    protected AuthCode findAuthCode(TokenRequest tokenRequest) {
        System.out.println("tokenRequestfind="+tokenRequest);
        System.out.println("getCode="+tokenRequest.getCode());
        System.out.println("tokenRequest.getRedirectUri()="+tokenRequest.getRedirectUri());
